// Carga de los 24 prospectos A/B investigados (gastronomía de alto flujo y clubes/entidades
// deportivas), con su mensaje borrador ya redactado.
//
// Uso: completar TURSO_DATABASE_URL / TURSO_AUTH_TOKEN en .env (los mismos que usa Vercel en
// producción) y correr:
//   bun scripts/seed-prospectos-ab.mjs
//
...
const datos = JSON.parse(readFileSync(join(here, 'seed-data', 'prospectos-a-b.json'), 'utf8'));
